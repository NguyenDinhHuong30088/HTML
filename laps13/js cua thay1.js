    ...
    function loadData(){
        ...
        xhttp.onreadystatechange = function (){
            if(this.readyState == 4 && this.status == 200){
                var rs = this.responseText; //nhan text/jison tu
                rs = JSON.parse(rs);//chuyen thanh object jison
        ...
        xhttp.open("GET","https://t2008mhuong.herokuapp.com/laps13/lap%20cua%20thay.html?_ijt=p65nlps32nll5lkkrv05vijnsk");
        xhttp.send();
    }
loadData();
